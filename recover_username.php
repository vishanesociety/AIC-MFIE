...
<body>
    ...
    <div class="container">
        <div class="row content">
            <div class="col-md-6 mb-3" style="display: flex; justify-content:center; align-items:center;">
            ...
            <div class="col-md-6 ">
                ...
                <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
                    ...
                    <div style="margin-top: 7%">
                        <input name="submit" type="submit" class="btn btn-class" value="send">
                    </div>
                    <br></br>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($emailcount) {
                        ...
                        $body = "Hi, $fname $lname your user name is  $Username   ";
